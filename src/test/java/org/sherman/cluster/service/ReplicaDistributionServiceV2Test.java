    ...
    public void case11() {
        ...
        Assert.assertEquals(
            ...
            new ImmutableMap.Builder<>()
                ...
                .put(4, ImmutableList.of(4, 3, 2))
                .put(5, ImmutableList.of(5, 4, 3))
                .put(6, ImmutableList.of(6, 5, 4))
                .put(7, ImmutableList.of(7, 6, 5))
                .put(8, ImmutableList.of(0, 7, 6))
                .put(10, ImmutableList.of(2, 1))
                .put(11, ImmutableList.of(3, 2))
                .put(12, ImmutableList.of(4, 3))
                .put(13, ImmutableList.of(5, 4))
                .put(14, ImmutableList.of(6, 5))
                .put(15, ImmutableList.of(1, 0, 7))
                .put(16, ImmutableList.of(7, 6))
                .build()
        );
    }
