...
public class LeaderReplicaDistributionServiceTest {
    ...
    public void case1() {
        ...
        Assert.assertEquals(
            ...
            ImmutableMap.of(
                0, ImmutableList.of(new Job("index_1", 40)),
                1, ImmutableList.of(new Job("index_2", 40)),
                2, ImmutableList.of(new Job("index_1", 40)),
                3, ImmutableList.of(new Job("index_2", 40))
            )
        );
    }
    ...
    public void case2() {
        ...
        Assert.assertEquals(
            ...
            ImmutableMap.of(
                0, ImmutableList.of(new Job("index_1", 40), new Job("index_5", 10), new Job("index_4", 40)),
                1, ImmutableList.of(new Job("index_2", 40), new Job("index_1", 40), new Job("index_5", 10)),
                2, ImmutableList.of(new Job("index_3", 40), new Job("index_2", 40)),
                3, ImmutableList.of(new Job("index_4", 40), new Job("index_3", 40))
            )
        );
    }
